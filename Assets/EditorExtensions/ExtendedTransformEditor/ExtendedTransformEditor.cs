/* 
 * About:
 * Extend the Transform Compoent to use a custom editor
 * Adds a Reset button for Position,Rotation,Scale
 * Adds buttons to easily copy and paste transform data
 * 
 * Source:
 * https://gist.github.com/GhatSmith/66d2a5a60d278eaaf85a6b12d79fc633
 * 
 */
...
public class ExtendedTransformEditor : Editor
{
    ...
    private static GUIContent positionGUIContent = new(LocalString("Position"));
    private static GUIContent rotationGUIContent = new(LocalString("Rotation"));
    private static GUIContent scaleGUIContent = new(LocalString("Scale"));
    ...
    public override void OnInspectorGUI()
    {
        ...
        EditorGUIUtility.wideMode = ExtendedTransformEditor.WIDE_MODE;
        EditorGUIUtility.labelWidth = EditorGUIUtility.currentViewWidth - ExtendedTransformEditor.FIELD_WIDTH; // align field to right of inspector
