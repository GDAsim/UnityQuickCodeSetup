...
public static class HierachyHighlightLoader
{
    ...
    static void DrawHierachyItemWithHighlight(HierarchyItem item, HierachyHighlight highlight)
    {
        ...
        Color32 bgcolor = item.IsSelected ?
           UnityEditorColors.GetDefaultBackgroundColor(UnityEditorHelpers.IsHierarchyWindowFocused, item.IsSelected) :
        ...
        Color textColor = item.IsSelected ?
            UnityEditorColors.GetDefaultTextColor(UnityEditorHelpers.IsHierarchyWindowFocused, item.IsSelected) :
            highlight.textColor;
